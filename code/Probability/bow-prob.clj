;; This computes the BOW probabilities of a sample sentence of a corpus 
;; using the frequencies of the words in the corpus. 
...
(def moby-sentence (sample-BOW-sentence 3 moby-vocab moby-word-probabilities))
(println moby-sentence)
(def moby-sentence-probability (compute-BOW-prob moby-sentence moby-vocab moby-word-probabilities))
(println moby-sentence-probability)